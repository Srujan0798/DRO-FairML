...
\subsection{Image data (UTKFace) --- future work; full grid not claimed}
...
features are available locally
(\texttt{data/raw/utkface\_features.npz}); a multi-seed Fairness-Targeted
PGD grid is not claimed in this draft.  See \S\ref{sec:results-utkface}.
