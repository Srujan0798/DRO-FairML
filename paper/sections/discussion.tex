...
\subsection{Image data (UTKFace) --- future work, no real run}
...
withdrawn; the only UTKFace outputs to date are synthetic smoke tests
(random Gaussian features), since GPU access was never granted.  The
modality question remains open.  See \S\ref{sec:results-utkface}.
