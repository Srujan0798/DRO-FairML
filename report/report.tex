...
% ── Colour palette ────────────────────────────────────────────────────────────
\definecolor{dro}{RGB}{0,158,115}        % teal / DRO-FAIR
\definecolor{naive}{RGB}{213,94,0}       % vermillion / Naive-FAIR
...
\rowcolors{2}{gray!8}{white}
\begin{tabular}{L{3.8cm}C{2cm}C{1.8cm}L{7cm}}
\toprule
\rowcolor{hdrblue!90}
...
\label{tab:datasets}
\rowcolors{2}{gray!8}{white}
\begin{tabular}{L{2cm}C{2cm}C{2cm}C{3cm}C{3.5cm}C{2.5cm}}
\toprule
\rowcolor{hdrblue!90}
...
\begin{figure}[p]
  ...
  \caption{\textbf{Figure~1: Main results.}
    DRO-FAIR (\textcolor{dro}{teal}) vs Naive-FAIR (\textcolor{naive}{vermillion})
    across all datasets and metrics on the clean test set.
    Shaded bands $=\pm 1\,\mathrm{SE}$.
    Significance markers above DRO line: $*p{<}0.05$,\;
    $**p{<}0.01$,\; $***p{<}0.001$ (Wilcoxon one-sided).
    Grey band at $\alpha=0$ $=$ no-corruption baseline.}
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~2: DP Reduction Heatmap.}
    Percentage DP reduction of DRO-FAIR over Naive-FAIR.
    Colour scale capped at $\pm 100\%$; exact value shown.
    $\triangle$ marks Adult $\alpha=0.3$ cell where DRO collapses ($-206\%$,
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~3: Statistical Significance Matrix.}
    \textcolor{dro}{Teal} $=$ DRO significantly better;
    \textcolor{naive}{orange} $=$ Naive significantly better;
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~4: Accuracy--Fairness Tradeoff.}
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~5: Win-Rate Summary.}
...
\[
  \lDP\uparrow \;\Rightarrow\;
  \text{model over-penalises DP}\;\Rightarrow\;
  \text{group rates equalised}\;\Rightarrow\;
  \text{model collapses to constant}\;\Rightarrow\;
  \text{accuracy}\approx 25\text{--}40\%
\]
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~6: Seed Stability Boxplots.}
    Per-seed DRO-FAIR accuracy (10 seeds).
    Adult $\alpha=0.3$ shows extreme bimodal distribution.
...
\begin{figure}[htbp]
  ...
  \caption{\textbf{Figure~7: Clean vs.\ Corrupted Test.}
    DP violation on clean (\textcolor{dro}{solid}) vs.\ adversarially
    corrupted (\textcolor{naive}{dashed}) test sets.
...
\label{tab:theory}
\rowcolors{2}{gray!8}{white}
\begin{tabular}{L{3.5cm}L{5cm}C{2cm}L{5cm}}
\toprule
\rowcolor{hdrblue!90}
