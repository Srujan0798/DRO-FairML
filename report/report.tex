...
\begin{table}[H]
\centering\small
\caption{Main Results: DRO-FAIR vs Naive-FAIR under Adversarial Corruption (clean test, mean over 3 seeds, tau=1 canonical (results/tau1\_summary.csv 37 rows; see auto\_generated)).}
...
\begin{table}[H]
\centering\small
\caption{Fairness-targeted PGD attacks: DRO vs Naive ($\alpha$=0.2, mean$\pm$SE over 5 seeds). tau=1 canonical (auto\_generated\_pgd.tex + tau1\_summary.csv). LSAC framed on IF per Q3/Q7.}
