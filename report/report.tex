...
\begin{table}[H]
\centering\small
\caption{Main Results: DRO-FAIR vs Naive-FAIR under Adversarial Corruption (clean test, mean $\pm$ SE over 3 seeds, $\tau{=}1$ canonical).}
...
\begin{table}[H]
\centering\small
\caption{Fairness-targeted PGD attacks: DRO vs Naive (mean over 3 seeds, $\tau{=}1$ canonical).}
