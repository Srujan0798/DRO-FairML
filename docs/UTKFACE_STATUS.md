...
|-----|------|--------|--------|
| **U1** CUDA repro | `results/utkface_flair2.json` | 90 | **20/90** — dp α=0.3 seeds 0–1; s=2 running |
| **U2** 5-race multi | `results/utkface_multigroup.json` | 30 | **20/30** — α=0.3 seeds 0–1; s=2 running |
| **U3** pixel PGD | `results/utkface_pixel_pgd.json` | 24 (planned) | **JPEGs ready** (symlink 23708); launch after U1/U2 free GPU |

- Repro: **20** matched, max\|ΔDP_dro\|≈0.007 (**0 GAP**). α=0.3 s0–1 |Δ|≤0.0006. Summary: `results/utkface_reproducibility_summary.md`
- Multi-group partial: `results/utkface_multigroup_summary.md` (α=0.3 2/2 multi wins so far)
