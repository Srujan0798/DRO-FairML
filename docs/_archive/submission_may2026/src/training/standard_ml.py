...
class StandardMLTrainer:
    ...
    def __init__(self, model, device='cpu', lr=1e-3, epochs=50,
    ...
    def fit(self, X, y, X_val=None, y_val=None, verbose=False):
        """Train standard classifier with minibatch SGD."""
        ...
        for epoch in range(self.epochs):
            ...
            for start in range(0, n, self.batch_size):
                ...
                loss = F.binary_cross_entropy_with_logits(logits, y_t[batch_idx])
            ...
            if X_val is not None and (epoch + 1) % 5 == 0:
                ...
                if verbose:
                    print(f"Epoch {epoch+1}/{self.epochs}: loss={avg_loss:.4f}, val_acc={acc:.4f}")
