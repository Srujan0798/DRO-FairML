...
(43/72 rows). Adult constant-predictor acc = **0.7521**.

## Coverage

- λ-grid rows present: **43/72** (59.7%)
...
| 0.3 | 0.00 | 0.001 | 2 | 0.2654 | 0.6792 | ✗ | -0.0076 | -0.0081 |
| 0.3 | 0.00 | 0.005 | 1 | 0.2730 **default** | 0.6872 | ✗ | +0.0000 | +0.0000 |
| 0.3 | 0.01 | 0.001 | 1 | 0.2739 | 0.6867 | ✗ | +0.0009 | -0.0006 |
| 0.3 | 0.01 | 0.005 | 1 | 0.2727 | 0.6879 | ✗ | -0.0003 | +0.0007 |
| 0.3 | 0.10 | 0.001 | 1 | 0.2554 | 0.6965 | ✗ | -0.0176 | +0.0093 |
| 0.3 | 0.10 | 0.005 | 1 | 0.2523 | 0.6971 | ✗ | -0.0207 | +0.0098 |
...
- α=0.3, λ_init=0.10, lr_λ=0.001: ΔDP=-0.0176, Δacc=+0.0093 (n=1)
- α=0.3, λ_init=0.10, lr_λ=0.005: ΔDP=-0.0207, Δacc=+0.0098 (n=1)
- α=0.3, λ_init=0.01, lr_λ=0.005: ΔDP=-0.0003, Δacc=+0.0007 (n=1)
