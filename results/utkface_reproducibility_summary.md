...
- flair2 rows: **23/90** (`results/utkface_flair2.json`)
...
| dp | 0.3 | 5 | -0.0023 | -0.0020 | OK |

## Matched seed-wise (all completed GPU cells)
- Matched cells: **23**
- max\|Δ DP_dro clean\| = **0.0072**
- max\|Δ DP_dro corrupted\| = **0.0080**
- mean Δ DP_dro clean = +0.00056
- Largest clean DP deltas (honest outliers, still OK if < thr):
  ...
  - dp α=0.2 s=5: gpu=0.1595 mac=0.1587 |Δ|=0.0008
  - dp α=0.3 s=3: gpu=0.1919 mac=0.1913 |Δ|=0.0006
